...
class FitpassDashboard : AppCompatActivity(), FitpassHomeListener {
    ...
    fun encodeBase64Url(){
        ...
        var fitpassConfig = FitpassConfig.getInstance()
        var concaturl:String= "latitude==="+FitpassPrefrenceUtil.getStringPrefs(this,FitpassPrefrenceUtil.LATITUDE,"0.0")+
                ...
                "&&&user_id==="+FitpassPrefrenceUtil.getStringPrefs(this,FitpassPrefrenceUtil.USER_ID,"")+
        Log.d("weburl",weburl)
